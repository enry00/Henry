...
def cap_4t():
    ...
    q['temp'].resample('h').mean().plot(lw=3,ls=':',alpha=2,label='moyenne',c='black')
...
def cap_5t():
    plt.figure(figsize=(15,5))
    c['temp'].plot(label='Température capteur 5',alpha=2,lw=2,ls='-.',c='red')
...
def cap_5n():
    plt.figure(figsize=(15,5))
    c['noise'].plot(label='Bruit capteur 5',alpha=2,lw=2,ls='-.',c='red')
...
def cap_5h():
    plt.figure(figsize=(15,5))
    c['humidity'].plot(label='Humidité capteur 5',alpha=2,lw=2,ls='-.',c='red')
...
def cap_1l():
    plt.figure(figsize=(15,5))
    u['lum'].plot(label='Luminosité capteur 1',alpha=2,lw=2,ls='-.',c='red')
...
def cap_5l():
    plt.figure(figsize=(15,5))
    c['lum'].plot(label='Luminosité capteur 5',alpha=2,lw=2,ls='-.',c='red')
...
def cap_5c():
    plt.figure(figsize=(15,5))
    c['co2'].plot(label='CO2 capteur 5',alpha=2,lw=2,ls='-.',c='red')
